...
<OnMount>
    <div in:fly={{ y: 200, duration: 1300 }} class="py-16 gap-12 h-full flex flex-col justify-center items-center">
        ...
        <ProjectCard href="/projects/portfolio" target="_self" title="Personal Portfolio" subtitle="August 24'" description="Designed this very portfolio to help showcase what I'm working on!" src="/projects/Personal-Portfolio.webp" />
