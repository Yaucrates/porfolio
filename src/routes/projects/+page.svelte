...
<OnMount>
    <div in:fly={{ y: 200, duration: 1300 }} class="py-16 gap-12 h-full flex flex-col justify-center items-center">
        <ProjectCard href="https://www.calidojo.com/" title="CaliDojo" subtitle="Jan 1st, 24'" description="Designed a wensite that provides calisthenics information along with an affiliate marketing shopping page." src="/projects/CaliDojo.webp" />
