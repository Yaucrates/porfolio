...
<OnMount>
    <div in:fly={{ y: 200, duration: 1300 }} class="py-16 gap-12 h-full flex flex-col justify-center items-center">
        ...
        <ProjectCard href="/projects/dorm-dojo" title="Dorm Dojo" subtitle="E-Commerce Project — May ’24" description="A headless e-commerce storefront built with the Shopify API. The original store is no longer active, so the live demo uses placeholder products (e.g., snowboards instead of dorm decor)." src="/projects/DormDojoHomepage.webp" githubLink="https://github.com/Yaucrates/dormdojo" />
    </div>
</OnMount>